          ...
          <div className="container relative z-20 mx-auto px-4">
            <div className="max-w-2xl space-y-6 animate-in slide-in-from-bottom-10 duration-700 fade-in">
              ...
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight leading-tight">
                {t('advertiser.hero.title.1')}<br/>
                {t('advertiser.hero.title.2')}
              </h1>
              
              <p className="text-xl text-gray-300 leading-relaxed">
                {t('advertiser.hero.description')}
              </p>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
                  ...
                  <div className="absolute bottom-8 right-8 bg-white/90 backdrop-blur-md p-4 rounded-xl shadow-lg border border-white/20 animate-bounce-slow">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-foreground">{t('advertiser.marketplace.badge.active')}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:w-1/2 order-1 lg:order-2 space-y-8">
                <h2 className="text-3xl md:text-4xl font-bold leading-tight">
                  {t('advertiser.marketplace.title.1')}<br/>
                  {t('advertiser.marketplace.title.2')}
                </h2>
                <p className="text-lg text-muted-foreground">
                ...
                <div className="space-y-6">
                  {[
                    { title: t('advertiser.marketplace.feature1.title'), desc: t('advertiser.marketplace.feature1.desc') },
                    { title: t('advertiser.marketplace.feature2.title'), desc: t('advertiser.marketplace.feature2.desc') },
                    { title: t('advertiser.marketplace.feature3.title'), desc: t('advertiser.marketplace.feature3.desc') }
                  ].map((item, i) => (
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="lg:w-1/2 space-y-6">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                  {[
                    t('advertiser.interaction.list.1'), t('advertiser.interaction.list.2'),
                    t('advertiser.interaction.list.3'), t('advertiser.interaction.list.4')
                  ].map((item, i) => (

            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="lg:w-1/2 w-full flex justify-center lg:justify-end animate-in slide-in-from-right-10 duration-1000 fade-in delay-200">
                <div className="bg-zinc-800/80 backdrop-blur-md p-8 rounded-2xl border border-white/10 shadow-2xl max-w-md w-full">
                  <h3 className="text-lg font-medium text-gray-400 mb-6">{t('mediaOwner.stats.title')}</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-400">{t('mediaOwner.stats.rent')}</span>
                    ...
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-400">{t('mediaOwner.stats.self')}</span>
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">{t('mediaOwner.why.title')}</h2>
              <p className="text-lg text-muted-foreground">
                {t('mediaOwner.why.description')}
              </p>
            </div>
              ...
              {[
                {
                  ...
                  title: t('mediaOwner.why.card1.title'),
                  desc: t('mediaOwner.why.card1.desc')
                },
                {
                  icon: <Settings2 className="w-10 h-10 text-orange-500" />,
                  title: t('mediaOwner.why.card2.title'),
                  desc: t('mediaOwner.why.card2.desc')
                },
                {
                  icon: <Shield className="w-10 h-10 text-orange-500" />,
                  title: t('mediaOwner.why.card3.title'),
                  desc: t('mediaOwner.why.card3.desc')
                }
              ].map((item, index) => (
              ...
              <div className="lg:w-1/2 space-y-6 order-2 lg:order-1">
                ...
                <div className="space-y-6 pt-4">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg">{t('mediaOwner.revenue.item1.title')}</h4>
                      <p className="text-muted-foreground">{t('mediaOwner.revenue.item1.desc')}</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg">{t('mediaOwner.revenue.item2.title')}</h4>
                      <p className="text-muted-foreground">{t('mediaOwner.revenue.item2.desc')}</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg">{t('mediaOwner.revenue.item3.title')}</h4>
                      <p className="text-muted-foreground">{t('mediaOwner.revenue.item3.desc')}</p>
                    </div>
                  </div>
                </div>
              </div>
